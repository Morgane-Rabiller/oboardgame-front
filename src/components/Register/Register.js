    ...
    return (
        <div className="register">
            ...
            <form className="register_form">
                ...
                <Password value={passwordRepeat} className="register_form-password p-inputtext-sm" onChange={(e) => setPasswordRepeat(e.target.passwordRepeat)} placeholder="Mot de passe" toggleMask />
